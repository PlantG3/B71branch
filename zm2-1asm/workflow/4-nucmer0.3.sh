...
export outdir=`realpath cache/4o-nucmer`
...
#sbatch --export=fa1=$asm,fa2=$B71,outdir=$outdir lib/nucmer.sbatch
export NC=/bulk/guifanglin/1-projects/2-wheatblast/0-ref/Neurospora_crassa_OR74A/NC12.fasta
sbatch --export=fa1=$asm,fa2=$NC,outdir=$outdir lib/nucmer.sbatch
